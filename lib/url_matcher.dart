...
abstract class UrlMatcher extends Comparable<UrlMatcher> {
  ...
  /// and a tail.
  String toUrl({final Map params,final String tail});
  ...
  int compareTo(final UrlMatcher other);
}
...
class UrlMatch {
  ...
  bool operator ==(final other) {
      return other is UrlMatch && other.match == match && other.tail == tail &&
          isMapEqual(other.parameters, parameters);
  }
